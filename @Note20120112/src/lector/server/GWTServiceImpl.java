...
public class GWTServiceImpl extends RemoteServiceServlet implements GWTService {
	...
	// METODOS NECESARIOS PARA LA RESOLUCI脫N DE LOS TIPOS POR RBOL
	...
	/*
	 * chequear, esta comentado el cloneFolderSys, esperando modificaci髇 de
	 * FolderSys
	 */
	...
	private void deepFolderDeletion(Long folderId) {
		...
		if (folder != null) {
			...
			for (int i = 0; i < foldersChildren.size(); i++) {
				ids.add(foldersChildren.get(i).getId());  // TODO revisar esta funci髇 no esta recorriendo profundidad
			}
	...
	public ArrayList<Long> getEntriesIdsByNames(ArrayList<String> names,
		...
		/*
		 * buscar tipos con los nombres/* buscar las carpetas con names a馻dir a
		 * la lista los tipos obtenidos a馻dir a la lista funcion-recursiva
		 * {lista de carpetas}
		 */
		EntityManager entityManager;
